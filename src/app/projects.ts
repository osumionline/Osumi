...
export const PORTFOLIO: ProjectInfoInterface[] = [
	...
	},
	{
		id: 'blog-oinarri',
		title: 'Blog Oinarri',
		short: 'Creación de tema personalizado para Wordpress para el blog de Oinarri SGR.',
	...
	},
	{
		...
		description: '<p>Aplicación en Facebook para Solán de Cabras que permite crear tu propia portada de revista, personalizandola con distintos aspectos y efectos.</p>',
		photos: 5
	}
];
